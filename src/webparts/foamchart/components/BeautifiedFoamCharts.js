...
(function() {
    ...
    function na() {
      function a() {
        ...
        for (var c = 0; c < e.length; c++) {
          var b = e[c];
          null !== b && (!0 === b.ee.call(b.context) ? e[c] = null : P.zc(b.repeat) && (b.repeat = b.repeat - 1, 0 >= b.repeat && (e[c] = null)))
        }
        e = e.filter(function(h) {
          return null !== h
        });
    ...
    var ra = ea.md(function() {
      ...
      g = ["font"];
      var d = "fillStyle globalAlpha globalCompositeOperation lineCap lineDashOffset lineJoin lineWidth miterLimit shadowBlur shadowColor shadowOffsetX shadowOffsetY strokeStyle textAlign textBaseline".split(" "),
        p = {};
      ...
      a.prototype.Na = function(m) {
        ...
        m instanceof ra ? c(m, this.buffer, this.ma) : b(m, this.buffer, this.ma, P.I(m.globalAlpha,
          1))
      };
      ...
      d.forEach(function(m) {
        Object.defineProperty(a.prototype, m, {
          set: function(c) {
            ...
            var b = this.buffer;
            b[this.ma++] =
              "globalAlpha" === m ? "setGlobalAlpha" : "set";
            b[this.ma++] = m;
            b[this.ma++] = c
          },
          get: function() {
      ...
      a.prototype.fillPolygonWithText = function(m, c, b, h, f) {
        ...
        if (t && P.has(f, "area")) {
          t.Qc ||
            (t.Qc = new ra);
          var n = f.area,
            k = P.I(f.cacheInvalidationThreshold, .05);
          m = ta.de(u, this, h, m, wa.F(m, {}), {
            x: c,
            y: b
          }, f.allowForcedSplit || !1, f.allowEllipsis || !1, t, n, k, f.invalidateCache)
        } else m = ta.re(u, this, h, m, wa.F(m, {}), {
          x: c,
          y: b
    ...
    var xa = ea.md(function() {
      ...
      a.prototype.bezierCurveTo = function(b,
        h, f, u, t, n) {
        var k = this.da;
    ...
    var Aa = function() {
      ...
      return {
        estimate: function() {
          ...
          for (d = 1; 6 >= d; d++) p = 2 * d * Math.PI / 6, m.push({
            x: 100 * Math.sin(p),
            y: 100 * Math.cos(p)
          });
          d = {
            polygonPlainFill: [q, function(k) {
    ...
    var ya = {
      ...
      Ti: function(a, q, l, g) {
        ...
        for (e = 0; e < m; e++) {
          ...
          wa.ga(t, b, g, f);
          u++;
          0 == e && (wa.ga(Math.min(.5, l / d[0]), c, b, p), u++, a.moveTo(p.x, p.y));
    ...
    function Da(a) {
      ...
      this.ic = function(w, z) {
        ...
        if (E < D) {
          ...
          E = w.x - .5 * (G - w.w);
          D = w.y
        } else E > D ? (G = w.w, O = w.w * k / n, E = w.x, D = w.y - .5 * (O - w.o)) : (E = w.x, D = w.y, G = w.w, O = w.o);
        E -= G * z;
        D -= O * z;
        G *= 1 + 2 * z;
        if (g(E, D, f.x, f.y, E + G, D, f.x + n / h, f.y, b)) return q(n / h / G, P.qa, !1);
        v = !1;
    ...
    var Ea = new function() {
      ...
      this.ga = function(l) {
        var g;
        return (g = /rgba\(\s*([^,\s]+)\s*,\s*([^,\s]+)\s*,\s*([^,\s]+)\s*,\s*([^,\s]+)\s*\)/.exec(l)) &&
          5 == g.length ? {
            r: parseFloat(g[1]),
            g: parseFloat(g[2]),
            b: parseFloat(g[3]),
            a: parseFloat(g[4]),
            model: "rgba"
          } : (g = /hsla\(\s*([^,\s]+)\s*,\s*([^,%\s]+)%\s*,\s*([^,\s%]+)%\s*,\s*([^,\s]+)\s*\)/.exec(l)) && 5 == g.length ? {
            h: parseFloat(g[1]),
            s: parseFloat(g[2]),
            l: parseFloat(g[3]),
            a: parseFloat(g[4]),
            model: "hsla"
          } : (g = /rgb\(\s*([^,\s]+)\s*,\s*([^,\s]+)\s*,\s*([^,\s]+)\s*\)/.exec(l)) && 4 == g.length ? {
            r: parseFloat(g[1]),
            g: parseFloat(g[2]),
            b: parseFloat(g[3]),
            a: 1,
            model: "rgb"
          } : (g = /hsl\(\s*([^,\s]+)\s*,\s*([^,\s%]+)%\s*,\s*([^,\s%]+)%\s*\)/.exec(l)) &&
          4 == g.length ? {
            h: parseFloat(g[1]),
            s: parseFloat(g[2]),
            l: parseFloat(g[3]),
            a: 1,
            model: "hsl"
          } : (g = /#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/.exec(l)) && 4 == g.length ? {
            r: parseInt(g[1], 16),
            g: parseInt(g[2], 16),
            b: parseInt(g[3], 16),
            a: 1,
            model: "rgb"
          } : (g = /#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])/.exec(l)) && 4 == g.length ? {
      ...
      this.T = function(l) {
        function g(b, h, f) {
          0 > f && (f += 1);
          1 < f && --f;
          return f < 1 / 6 ? b + 6 * (h - b) * f : .5 > f ? h : f < 2 / 3 ? b + (h -
            b) * (2 / 3 - f) * 6 : b
        }
  
        function e(b, h, f) {
          return Math.sqrt(b * b * .241 + h * h * .691 + f * f * .068) / 255
        }
      ...
      this.ua = function(l) {
        return "rgba(" + (.5 + l.r | 0) + "," + (.5 + l.g | 0) + "," + (.5 + l.b | 0) + "," + l.a + ")"
      };
      this.ta = function(l) {
        return "rgba(" + (.5 + l.r | 0) + "," + (.5 + l.g | 0) + "," + (.5 + l.b | 0) + ")"
      };
      this.sa = function(l) {
        return "hsla(" + (.5 + l.h | 0) + "," + (.5 + l.s | 0) + "%," + (.5 + l.l | 0) + "%," + l.a + ")"
      };
      this.H = function(l) {
        return "hsl(" + (.5 + l.h | 0) + "," + (.5 + l.s | 0) + "%," + (.5 + l.l | 0) + "%)"
      };
      this.i = function(l, g, e) {
        return "hsl(" + (.5 + l | 0) + "," + (.5 + g | 0) + "%," + (.5 + e | 0) + "%)"
      }
    };
    ...
    function Ga(a) {
      var q = new Fa,
        l = a.length;
      if (0 < a.length)
        for (var g = a.length - 1; 0 <= g; g--) a[g].then(function() {
          0 === --l && q.resolve()
        });
      else q.resolve();
      return q.promise()
    ...
    function Ka(a) {
      ...
      function g(H, B, M) {
        ...
        e(H, M);
        (void 0 === M.Db && M.$h || "prevent" === M.Db) && H.preventDefault();
        return M
      }
  
      function e(H, B) {
        Ia.oe(a, H.clientX, H.clientY, B);
        B.altKey = H.altKey;
        B.metaKey = H.metaKey;
        B.ctrlKey = H.ctrlKey;
      ...
      d.addEventListener("mouseup", function(H) {
        var B = g(H, b);
        G && (O && g(H, k), window.clearTimeout(y), v || O || !l(H) || (B = {
          x: B.x,
          y: B.y
        }, w && 100 > wa.i(B, w) ? g(H, h) : g(H, p), w = B, z = window.setTimeout(function() {
          w = null
        }, 350)), O = G = !1)
      });
      ...
      d.addEventListener("wheel", q(function() {
        return function(H) {
    ...
    var La = function() {
      ...
      function l(e) {
        return function(d) {
          return 1 > (d *= 2) ? .5 * Math.pow(d, e) : 1 - .5 * Math.abs(Math.pow(2 - d, e))
        }
      }
    ...
    var P = {
      ...
      Ne: function(a) {
        return P.V(a) || P.Re(a) || P.Ac(a) && !/\S/.test(a)
      },
      has: function(a, q) {
      ...
      extend: function(a) {
        P.Bg(Array.prototype.slice.call(arguments, 1), function(q) {
          if (q)
            for (var l in q) q.hasOwnProperty(l) && (a[l] = q[l])
        });
        return a
      },
      xj: function(a, q) {
      ...
      I: function() {
        for (var a = 0; a < arguments.length; a++) {
          var q = arguments[a];
          if (!(P.V(q) || P.zc(q) &&
              isNaN(q) || P.Ac(q) && P.Ne(q))) return q
        }
      },
      If: function(a, q) {
        q = a.indexOf(q);
    ...
    function Oa() {
      ...
      this.D = function(q, l) {
        var g = a[q];
        if (g)
          for (var e = Array.prototype.slice.call(arguments, 1), d = 0; d < g.length; d++) g[d].apply(this, e)
      }
    };
    var Pa = {
      Pf: function(a) {
      ...
      this.K = function() {
        ...
        function h(k) {
          ...
          this.before = function() {
            z = {};
            for (var D in k.P) y.hasOwnProperty(D) && (z[D] = {
    ...
    var wa = new function() {
      ...
      this.T = function(l, g, e, d, p) {
        ...
        var f = d.y - h;
        d = c * f - e * g;
        if (!(1E-12 >= d && -1E-12 <= d) && (b -= m, h -= l, e = (b * f - e * h) / d, d = (b * g - c * h) / d, 0 <= d && (p || 1 >= d) && 0 <= e && 1 >= e)) return {
          x: m + c * e,
          y: l + g * e
        }
      };
      this.Lb = function(l, g, e, d) {
        ...
        d = d.y - e;
        var h = m * d - b * g;
        if (!(1E-12 >= h && -1E-12 <= h) && (d = ((c - p) * d - b * (e - l)) / h, 0 <= d && 1 >= d)) return {
          x: p + m * d,
          y: l + g * d
        }
      };
      ...
      this.u = function(l, g) {
        for (var e = 0, d = 0, p = l.length, m = l[0], c = 0, b =
            1; b < p - 1; b++) {
          var h = l[b],
            f = l[b + 1],
            u = m.y + h.y + f.y,
      ...
      this.sa = function(l, g) {
        for (var e = 0; e < l.length; e++) {
          var d = l[e],
            p = l[e + 1] || l[0];
          if (0 > (g.y - d.y) * (p.x - d.x) - (g.x - d.x) * (p.y - d.y)) return !1
        }
        return !0
      };
      ...
      this.i = function(d) {
        function p(Z, C, U) {
          ...
          for (c = 0; c < ba; c++) {
            var I = C[c].Rc;
            S[I.index] = !0;
            0 > ja * (I.x - ha.x) + N * (I.y - ha.y) + aa * (I.z - ha.z) && a.add(Z, I)
          }
          C = U.Ya;
          ba = C.length;
          for (c = 0; c < ba; c++) I = C[c].Rc, !0 !== S[I.index] && 0 > ja * (I.x - ha.x) + N * (I.y - ha.y) + aa * (I.z - ha.z) && a.add(Z, I)
        }
        var m, c, b = d.length;
        ...
        if (0 < (f = function() {
            function Z(T, R, V, fa) {
              ...
              var K = x.z * A.x - x.x * A.z;
              x = x.x * A.y - x.y * A.x;
              return F * fa.x + K * fa.y + x * fa.z > F * T.x + K * T.y + x * T.z ? new q(T, R, V) : new q(V, R, T)
            }
            ...
            h.push(N, S, ba, I);
            for (U = 4; U < b; U++)
              for (ha = d[U], aa = 0; 4 > aa; aa++) ja = h[aa], N = ja.la[0], S = ja.Ha, 0 > S.x * (ha.x - N.x) + S.y * (ha.y - N.y) + S.z * (ha.z - N.z) && a.add(ja, ha);
            return 4
          }())) {
          for (; f < b;) {
            var u = d[f];
            if (u.Pb) {
              ...
              var y = k,
                v = r;
              do
                if (t.push(y), n.push(v), v = (v + 1) % 3, !1 === y.J[v].visible) {
                  do
                    for (m = y.la[v], y = y.J[v], c = 0; 3 > c; c++) y.la[c] == m && (v = c); while (!1 === y.J[v].visible && (y !== k || v !== r))
                } while (y !== k || v !== r);
              var w = null,
                z = null;
    ...
    var Ua = new function() {
        ...
        function g(n) {
          ...
          a: for (; w < v; w++)
            for (var z = 1; z < v; z++) {
              ...
              if (null !== E) {
                if (E[1] === r)
                  if (k.unshift(E), r = E[0], n[z] = null, k.length === v) break a;
                  else continue;
                if (E[0] === y && (k.push(E),
                    y = E[1], n[z] = null, k.length === v)) break a
              }
            }
          ...
          for (y = 0; y < z; y++) {
            ...
            if (1E-12 < wa.i(X.ea, Y.ea))
              ...
              for (E = 0; E < D; E++) {
                ...
                if (B = wa.T(k[G], k[U], X.ea, Y.ea, !1)) {
                  if (-1 !== H)
                    for (Z = H; G != Z;) Z = (Z + 1) % D, v.push(k[Z]), w.push(null);
                  v.push(B);
                  w.push(r[M][2]); - 1 === O && (O = G);
                  break
                }
                G = U
              } else if (!X.jb && Y.jb)
        ...
        if (1 === q.length) q[0].C = l.slice(0), q[0].J = [];
          ...
          for (d = 0; d < p.length; d++) {
            ...
            m.push({
              x: c.x,
              y: c.y,
              z: c.x * c.x + c.y * c.y - c.w
            })
          }
          for (d = 0; d < q.length; d++) c = q[d], c.C = null, m.push({
            x: c.x,
            y: c.y,
            z: c.x * c.x + c.y * c.y - c.w
          });
      ...
      this.u = function(q, l) {
        ...
        if (e) {
          ...
          for (g = 0; g < d; g++) p = q[g], n = Math.min(Math.sqrt(p.w), .95 * p.Ze), p.w = n * n;
          this.i(q, l);
          for (g = 0; g < d; g++) p = q[g], p.Yd !== p.w && 0 < p.kc && (l = Math.min(p.kc, p.Yd - p.w), p.w +=
            l, p.kc -= l)
        }
      }
    };
        ...
        if (g[0].J) {
          ...
          for (q = q.Zb = 0; p < d;)
            if (g = e[p++], !g.Sc && g.J) {
              ...
              for (a = 0; a < c; a++) {
                var b = m[a];
                b && !0 !== b.Sc && (0 === b.Zb && (b.Zb = g.Zb + 1), e[d++] = b)
              }
            }
        } else
          for (a = 0; a < g.length; a++) l(g[a], a, 1)
      }
    };
    var ta = function() {
      function a(n, k, r, y, v, w, z, E) {
        ...
        u.text = r;
        e(y, v, w, t);
        if (/[\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf]/.test(r)) g(u), l(k, u, B), d(D, u, t, H, O, !0, M);
        else if (l(k, u, B), d(D, u, t, H, O, !1,
            M), !M.ka && (z && (g(u), l(k, u, B)), E || z)) E && (M.Ub = !0), d(D, u, t, H, H, !0, M);
        if (M.ka) {
          var Q = "",
            X = 0,
            Y = Number.MAX_VALUE,
      ...
      function d(n, k, r, y, v, w, z) {
        ...
        if (0 >= G) z.ka = !1;
          ...
          do {
            var X = (H + v) / 2,
              Y = Math.min(O.length, Math.floor((G + X * (E - 1 - 2 * D)) / (X * E))),
              Z = void 0;
            if (0 < Y) {
              var C = 1,
                U = Y;
          ...
          void 0 === Q ? (z.ka = !1, z.fontSize = 0) : (z.ka = !0, z.fontSize = Q, z.bc = M, z.Ub = w && X === H);
          return z
        }
      }
      ...
      function p(n, k, r, y, v, w, z, E) {
        ...
        switch (n.verticalAlign) {
          ...
          case "bottom":
            ...
            break;
          default:
            v = Q.y - (y * (r - 1) / 2 + G * (r - 1) / 2), Z = 1
        }
        n = v;
        for (O = 0; O < r; O++) b[2 * O] = v - y / 2, b[2 * O + 1] = v +
          y / 2, v += Z * y, v += Z * G;
        ...
        Y = (Y + 1) % C;
        for (var aa = 0; aa < v;) {
          for (var ja = O[aa], N = M[X]; N.y < ja;) U = X, X = (X - 1 + C) % C, N = M[X];
          for (var S = M[Y]; S.y < ja;) ha = Y, Y = (Y + 1) % C, S = M[Y];
          var ba = M[U],
            I = M[ha];
          S = I.x + (S.x - I.x) * (ja - I.y) / (S.y - I.y);
          Z[aa][0] = ba.x + (N.x - ba.x) * (ja - ba.y) / (N.y - ba.y);
          Z[aa][1] = S;
          aa++
        }
        for (O = 0; O < r; O++) M = 2 * O, v = Q.x, Z = v - h[M][0], C = h[M][1] - v, Z = Z < C ? Z : C, C = v - h[M + 1][0], M = h[M + 1][1] - v, M = C < M ? C : M, f[O] = 2 * (Z < M ? Z : M) - D * y;
        U = H[" "] * y / 100;
        Z = H["\u2026"] *
          y / 100;
        D = 0;
        ...
        for (O = 0; O < B.length; O++) {
          ...
          if (Q + C < X && B.length - O >= r - D && "\n" != M) Q += C, " " === ha && (Q += U), z && z(v, M);
            ...
            if (D + 1 >= r) {
              if (w) {
                r = X - Q - Z;
                if (r > Z || C > Z) r = Math.floor(v.length * r / C), 0 < r && z && z(v.substring(0, r), M);
                z && z("\u2026", void 0);
                E && E(D, n, v, M, Q);
                return !0
              }
      ...
      return {
        ...
        de: function(n, k, r, y, v, w, z, E, D, G, O, H) {
          var B = 0,
            M = 0;
          r = r.toString().trim();
          if (!H && D.result && r === D.Xf && Math.abs(G - D.Zd) / G <= O) {
            var Q = D.result;
            Q.ka && (B = w.x - D.eg, M = w.y - D.fg, O = D.Qc, k.save(), k.translate(B, M), O.Na(k), k.restore())
          }
          Q || (O = D.Qc, O.clear(), Q = a(n, O, r, y, v, w, z, E), Q.ka && O.Na(k),
            D.Zd = G, D.eg = w.x, D.fg = w.y, D.result = Q, D.Xf = r);
          return Q.ka ? {
            ka: !0,
            bc: Q.bc,
            fontSize: Q.fontSize,
        ...
        return function(d, p, m, c) {
          function b(r, y, v, w, z) {
            if (0 != r.length) {
              ...
              G = v;
              B = D / z;
              do D = E.shift(), H = D.lc, O = H / B, H = D, M = G, Q = O, H.x = y + B / 2, H.y = M + Q / 2, m && h(D, y, G, B, O), G += O; while (0 < E.length);
          ...
          p = p.o;
          if (0 != d.length)
            if (1 == d.length) d[0].x = f + t / 2, d[0].y = u + p / 2, d[0].nd = 0, m && h(d[0], f, u, t, p);
            else {
              d = d.slice(0);
    ...
    function Ya(a) {
      function q(k, r) {
        ...
        var y = e(r),
          v = 0;
        if (("flattened" === a.mb || "always" === a.zg && k.group && k.group.description) && 0 < r.length && 0 < k.level) {
      ...
      function g(k) {
        P.has(k, "__id") || (Object.defineProperty(k, "__id", {
          enumerable: !1,
          configurable: !1,
          writable: !1,
          value: h
      ...
      function d(k) {
        if (!k.empty()) {
          ...
          for (y = k.length - 1; 0 <= y; y--) v = k[y], v.cg = v.weight / r
        }
      }
      ...
      function m() {
        for (var k = b.m.reduce(function(v, w) {
          ...
          var y = b.m[r];
          y.attribution && (y.weight = Math.max(.025, a.sg) * k)
        }
      }
      var c = this,
        b = new Za,
      ...
      this.T = function(k) {
        var r = k.group.groups,
          y = a.Rh;
        return !k.m && !k.description && r && 0 < r.length && n + r.length <= y ? (n += r.length, q(k, r), d(k), p(k), !0) : !1
      };
          ...
          Ra.za(r, function(y) {
            if (!y.empty()) {
              ...
              for (var v = e(y.map(function(E) {
                ...
                var z = y[w];
                z.weight = 0 < z.group.weight ? z.group.weight : .9 * v
              }
            }
          });
          d(r);
    ...
    function ab(a) {
      function q(B, M) {
        ...
        M.opacity = 1;
        M.Da = 1;
        M.va = 0 > B ? 1 - t.Ch / 100 * B : 1;
        M.saturation = 0 > B ? 1 - t.Dh / 100 * B : 1;
        M.ca = 0 > B ? 1 + .5 * B : 1
      }
  
      function l(B) {
        B = B.ja;
        return Math.max(.001, 0 === B ? 1 : 1 + B * (t.Pa - 1))
      }
      ...
      function e(B, M, Q, X) {
        ...
        var Z = B.reduce(function(aa, ja) {
            aa[ja.id] = !0;
            return aa
          }, {}),
          C = [];
        B = [];
        if (z.reduce(function(aa, ja) {
            return aa || Z[ja.id] && (!ja.U || 1 !== ja.ja) || !Z[ja.id] && !ja.parent.U && (ja.U || -1 !== ja.ja)
          }, !1)) {
          var U = [],
            ha = {};
          z.forEach(function(aa) {
            Z[aa.id] && (aa.U || C.push(aa), aa.U = !0, Ra.za(aa, function(ja) {
              U.push(b(ja, 1));
              ha[ja.id] = !0
            }))
          });
          0 < U.length ? (Ra.L(n, function(aa) {
            Z[aa.id] || (aa.U && C.push(aa), aa.U = !1);
            ha[aa.id] ||
              U.push(b(aa, -1))
          }), B.push(v.K.A({}).Qa(U).call(h).Ta()), d(Z), B.push(p(Y)), Q && (y.ic(E, t.Yb, t.Oa, La.ia(t.Wb)), y.Fb())) : (B.push(c(Q)), M && Ra.L(n, function(aa) {
            aa.U && C.push(aa)
          }))
        }
        return Ga(B).then(function() {
          r.bd(M, C, "exposed", function(aa) {
            return aa.U
          }, {
            indirect: X
      ...
      function d(B) {
        z.reduce(f(!0, void 0, function(M) {
          return M.U || B[M.id]
        }), u(E));
        E.x -= E.w * (t.Pa - 1) / 2;
        E.y -= E.o * (t.Pa - 1) / 2;
      ...
      function f(B, M, Q) {
        ...
        return function(Y, Z) {
          if (!Q || Q(Z)) {
            for (var C =
                B ? Z.$ || Z.C : Z.C, U, ha = C.length - 1; 0 <= ha; ha--) U = void 0 !== M ? M(Z, C[ha], X) : C[ha], Y.Hc = Math.min(Y.Hc, U.x), Y.wd = Math.max(Y.wd, U.x), Y.Ic = Math.min(Y.Ic, U.y), Y.xd = Math.max(Y.xd, U.y);
            Y.box.x = Y.Hc;
            Y.box.y = Y.Ic;
            Y.box.w = Y.wd - Y.Hc;
            Y.box.o = Y.xd - Y.Ic
    ...
    function bb(a) {
      ...
      this.u = function() {
        ...
        var h = a.options,
          ...
          G = [];
        d.initial() ?
          m.i(h.oi, h.mi, h.pi, h.ri, h.li) : m.i(h.Mf, h.Lf, h.Nf, h.Of, h.Kf);
        Va.u(l, Va.i(l, a.options.ni), function(O, H, B) {
          var M = "groups" === a.options.hi ? B : H;
    ...
    function cb(a) {
      ...
      this.Bb = function(c, b, h) {
        ...
        0 < c.length && a.j.D("foamtree:attachChildren",
          c);
    ...
    function db(a) {
      function q(e, d) {
        ...
        Ra.L(l, function(b) {
          !0 === b.selected && (b.selected = !b.selected, b.N = !b.N, b.Sa = !b.Sa)
        });
        var p;
    ...
    function eb(a) {
      ...
      function l() {
        function N(S) {
          return function(ba) {
            ba.x *= Y / u.clientWidth;
            ba.y *= Z / u.clientHeight;
            return S(ba)
          }
        }
        "external" !== f.Me && ("hammerjs" === f.Me && P.has(window, "Hammer") && (aa.M(u), aa.A("tap", N(h.i), !0), aa.A("doubletap", N(h.u), !0), aa.A("hold", N(h.sa), !0), aa.A("touch", N(h.ua), !0), aa.A("release", N(h.wa),
          ...
          (ba = ba || 0 <= T.indexOf(!1)) || 27 === S.keyCode && a.j.D("interaction:reset")
        }))
      }
      ...
      function d(N, S, ba) {
        ...
        return function(R) {
          ...
          }), fa = fa || 0 <= V.indexOf(!1), F && F.attribution && "click" === N && (fa = !1));
          fa || ba && ba({
            dd: F,
            ug: K
          }, R)
      ...
      function p(N) {
        function S(fa, x) {
          var A = x.m;
          if (A) {
            for (var F = -Number.MAX_VALUE, K, L = 0; L < A.length; L++) {
              var J = A[L];
              !J.description &&
                J.Y && ja(J, fa) && J.scale > F && (K = J, F = J.scale)
            }
            var W;
            K && (W = S(fa, K));
            return W || K || x
        ...
        for (var ba = C.length, I = C[0].scale, T = C[0].scale, R = 0; R < ba; R++) {
          var V = C[R];
          V = V.scale;
          V < I && (I = V);
          V > T && (T = V)
      ...
      function m(N, S) {
        if ("flattened" === f.mb) N = p(N);
          ...
          S = S || 0;
          for (var ba = C.length, I = void 0, T = 0; T < ba; T++) {
            var R = C[T];
      ...
      function c(N) {
        var S =
          ...
          ba = 0;
        Ra.sc(w, function(I) {
          !0 === I.open && I.Y && I.scale > ba && ja(I, N) && (S = I, ba = I.scale)
        });
        return S
      }
      var b = ea.Lh(),
        ...
        f = a.options,
        u, t, n, k, r, y, v, w, z = !1,
        E, D, G, O, H, B, M, Q, X, Y, Z;
      a.j.subscribe("stage:initialized", function(N, S, ba, I) {
        u = S;
        Y = ba;
        Z = I;
        l()
      });
      a.j.subscribe("stage:resized", function(N, S, ba, I) {
        Y = ba;
        Z = I
      });
      ...
      a.j.subscribe("openclose:initialized",
        function(N) {
          r = N
        });
      ...
      this.M = function() {};
      this.ua = e(d("mousedown", !1, function() {
        t.Wh()
      }));
      this.wa = e(d("mouseup", !1, void 0));
      this.i = e(d("click", !0, function(N, S) {
        S.lb || S.shiftKey || !(N = N.dd) || (N.attribution ? S.ctrlKey ? document.location.href =
          Pa.Pf("iuuqr;..b`ssnurd`sbi/bnl.gn`lusdd") : (S = La.ia(f.Kb), N.be ? (t.reset(f.ob, S), N.be = !1) : (t.bg(N, f.Yb, f.ob, S), N.be = !0)) : y.select({
            m: [N],
            Ca: !N.selected,
            Ba: S.metaKey || S.ctrlKey
          }, !0))
      }));
      this.u = e(d("doubleclick", !0, function(N, S) {
        var ba = N.dd;
        ba && ba.attribution || (S.lb || S.shiftKey ? ba && (ba.parent.U && (ba = ba.parent), N = {
          m: ba.parent !== w ? [ba.parent] : [],
          Ca: !0,
          Ba: !1
        }, y.select(N, !0), k.Vb(N, !0, !0, !1)) : ba && (N = {
          m: [ba],
          Ca: !0,
          Ba: !1
        }, ba.Va = !0, a.j.D("foamtree:attachChildren", [ba]), k.Vb(N, !0, !0, !1)), ba && n.K.A({}).wait(f.Oa /
          2).call(function() {
          r.Bb({
            m: Ra.uc(w, function(I) {
              return I.Bd && !Ra.Jh(ba, I)
            }),
            Ca: !1,
            Ba: !0
          }, !0, !0);
      ...
      this.sa = e(d("hold", !0, function(N, S) {
        (N = (S = !(S.metaKey || S.ctrlKey || S.shiftKey) && !S.lb) ? N.dd : N.ug) && N !== w && r.Bb({
          m: [N],
          Ca: S,
          Ba: !0
        }, !0, !1)
      }));
      this.ga = e(d("dragstart", !1, function(N, S) {
        E = S.x;
        D = S.y;
        G = Date.now();
        z = !0
      }));
      this.H = e(d("drag", !1, function(N, S) {
        if (z) {
          N = Date.now();
          B = Math.min(1, N - G);
          G = N;
      ...
      this.pb = e(d("transformstart", !1, function(N, S) {
        M = 1;
        E = S.x;
        D = S.y
      }));
      var U = 1,
        ha = !1;
      this.transform = e(d("transform", !1, function(N, S) {
        N = S.scale - .01;
        t.pg(S, N / M, S.x - E, S.y - D);
        M = N;
        E = S.x;
        D = S.y;
        U = M;
      ...
      this.Ka = e(d("transformend", !1, function() {
        ha && .8 > U ? a.j.D("interaction:reset") : g();
        ha = !1
      }));
      this.Ja = e(d("mousewheel", !1, function() {
        var N = P.yg(function() {
          g()
        }, 300);
        return function(S, ba) {
          S =
            f.ij;
          1 !== S && (S = Math.pow(S, ba.ed), b ? (t.qg(ba, S), N()) : t.Nb(ba, S, f.ob, La.ia(f.Kb)).then(g))
        }
      }()));
      this.ta = e(function() {
        var N = void 0,
        ...
        return function(V) {
          if ("out" === V.type) I = void 0, ba = I !== N;
          else if (t.absolute(V, S), N && !N.open && ja(N, S)) {
            var fa = m(S, N.scale);
            fa && fa !== N ? (ba = !0, I = fa) : ba = !1
          } else I = m(S), ba = I !== N;
          ba && (T(V), N = I, ba = !1);
          N && R(V)
        }
    ...
    function fb(a) {
      function q(e, d, p, m) {
        ...
        for (c = 1; c < e.length; c++) {
          var t = e[c],
            n = .95 * Math.pow(c / e.length, m);
          for (b += .3819; f < b;) f += h[u], u = (u + 1) % h.length;
      ...
      this.i = function(e, d, p) {
        if (0 < e.length) {
          p = l[p.relaxationInitializer || p.initializer || g.Ii || "random"];
          if ("box" === p.Ob) {
            var m = wa.F(d, {});
            p.vb(e, m);
            wa.wa(e, wa.H(m), d)
          ...
          for (p = e.length - 1; 0 <= p; p--) {
            m = e[p];
            if (m.description) {
              var c = wa.ta(d, g.qc, g.Ag);
              m.x = c.x;
              m.y = c.y
            }
            m.attribution && (c = wa.ta(d, g.$d, g.rg), m.x = c.x, m.y = c.y);
    ...
    function hb(a) {
      ...
      this.Oe = function(m) {
        return m === q ? !0 : 2 * Math.sqrt(m.O.ha / (Math.PI * m.m.length)) >= Math.max(l.Be, 5E-5)
      };
    ...
    function ib(a, q) {
      ...
      function g(n, k) {
        q.Oe(n) && (n.G || (n.G = Ta.i(n.C, f.jd * Math.pow(f.La, n.level - 1)), n.G && n.m[0] && n.m[0].description && "stab" == f.Tb && m(n)), n.G && (b.Eb(n), u.i(e(n), n.G, n.group), n.R = !0, k(n)), l(n))
      }
      ...
      function m(n) {
        ...
        for (var X = 0; H < B && 20 > X++;) {
          ...
          wa.u(Z[0], M);
          var C = M.ha - k;
          if (.01 >= Math.abs(C) / Q) break;
          else 0 < (0 == O ? 1 : -1) * C ? B = Y : H = Y
        }
        wa.F(Z[0], r);
        if (r.o < z || r.o > E) y.y = r.o < z ? v + w * Math.min(z, E) : v + w * E, Z = wa.ua(n.G, y, D);
        n.m[0].C = Z[0];
        n.G = Z[1]
      }
  
      function c(n) {
        n !== h && 2 * Math.sqrt(n.O.ha /
          (Math.PI * n.m.length)) < Math.max(.85 * f.Be, q.jg) && (n.R = !1, n.xa = !1, n.Ia = !0, n.G = null)
      }
      var b = this,
        h, f = a.options,
        u = new fb(a),
      ...
      this.Eb = function(n) {
        ...
        n.Dj = y;
        for (n = 0; n < k.length; n++) v = k[n], v.Vf = v.w, v.hc = r / Math.PI * (0 < y ? v.weight / y : 1 / k.length)
      }
    };
    ...
    function jb(a, q) {
      ...
      function g(b) {
        function h(t) {
          ...
          var w = m.qc;
          "bottom" == w || 0 <= w && 180 > w ? (y.o = v - k, t.G = wa.H(y), y.y += v - k, y.o = k, n()) : (y.o = k, n(), y.y += k, y.o = v - k, t.G =
            wa.H(y))
        }
    ...
    var kb = new function() {
      this.u = function(a, q) {
        ...
        a.globalAlpha = 1 * l;
        a.save();
        a.transform(.94115, 0, 0, .94247, -78.54, -58);
        a.beginPath();
        ...
        a.bezierCurveTo(185.9, 445.9, 185.6,
          445, 206.2, 510.7);
        ...
        a.bezierCurveTo(537.7,
          528.3, 534.2, 530.5, 527.8, 532.4);
        a.lineTo(522.3, 534);
        ...
        a.bezierCurveTo(159.9, 318.8, 181.1, 316.5,
          182.5, 316.5);
        ...
        a.bezierCurveTo(208.9,
          307.2, 208.5, 303.4, 209.9, 300);
        ...
        a.bezierCurveTo(556.6,
          341.8, 556.5, 375.7, 556.3, 377.2);
        ...
        a.bezierCurveTo(445, 197.6, 449.5, 197.9,
          454.2, 200.4);
        ...
        a.bezierCurveTo(84.11, 131.7, 84.27, 100.2, 84.77,
          96.34);
        ...
        a.bezierCurveTo(232.3, 235, 231.1,
          238.1, 230.2, 240);
        ...
        a.bezierCurveTo(257.7, 161.2, 256.9, 161.4, 309.3,
          151.9);
        ...
        a.bezierCurveTo(509.2,
          207.7, 499.9, 207.9, 497, 207.1);
        a.closePath();
        a.fill();
        a.globalAlpha = .2 * l;
        a.beginPath();
        ...
        a.bezierCurveTo(448, 64.06,
          449.9, 65.81, 450.7, 67.14);
        ...
        a.bezierCurveTo(205.1, 67.89, 205, 67.1,
          205.7, 65.54);
        ...
        a.fill();
        a.restore();
        a.transform(.15905, 0, 0, .15905, -88.65, 443.2);
        a.globalAlpha = 1 * l;
        a.save();
        a.beginPath();
    ...
    function lb(a, q) {
      function l(x, A) {
        ...
        var J = x.O.x;
        x = x.O.y;
        A.fillRect(J - L, x - L, K, K);
        A.fillRect(J - L - F, x - L, K, K);
        A.fillRect(J - L + F, x - L, K, K)
      }
  
      function g(x, A, F, K) {
        null === x && F.clearRect(0, 0, O, H);
        var L, J = Array(T.length);
        for (L = T.length - 1; 0 <= L; L--) J[L] = T[L].na(F, K);
        for (L = T.length - 1; 0 <= L; L--) J[L] && T[L].before(F, K);
        X.rc([F, G], function(W) {
          var ca;
          if (null !== x) {
            F.save();
          ...
          if (0 !== A.length) {
            ca = {};
            for (la = T.length - 1; 0 <= la; la--) T[la].ng(ca);
          ...
          for (ca = T.length - 1; 0 <= ca; ca--) ia = T[ca], J[ca] && ia.Nd(A, F, W)
        });
        for (L = T.length - 1; 0 <= L; L--) J[L] &&
          T[L].after(F);
        C.Zc && (F.canvas.style.opacity = .99, setTimeout(function() {
          F.canvas.style.opacity = 1
        }, 1))
      }
  
      function e(x) {
        k === y ? x < .9 * u && (k = r, w = z, c()) : x >= u && (k = y, w = E, c())
      }
  
      function d() {
        function x(L, J, W) {
          L.sb = Math.floor(1E3 * L.scale) - W * J;
          0 < L.opacity && !L.open && J++;
          var ca = L.m;
          if (ca)
            for (var ia = ca.length - 1; 0 <= ia; ia--) L.W && x(ca[ia], J, W)
        }
        var A = null,
          F = null,
          K = null;
        X.rc([], function(L) {
          ...
          J && (U.N = !0);
          var W = "onSurfaceDirty" === C.Lg;
          Ra.fd(U, function(da) {
            da.parent && da.parent.Z && (da.aa.clear(), da.Ma = !0, W || (da.oc = !0, da.Qb.clear()));
            W && (da.oc = !0, da.Qb.clear())
          });
          var ca = L.scale * L.scale;
          Ra.fd(U, function(da) {
            if (da.R) {
              ...
              if (da.W && !da.description && (da.Z || da.N || da.Fc && da.parent.X && da.Ma)) {
                ...
                if (qa)
                  ...
                  if (!da.selected && da.Sa) {
                    ...
                    for (ma = 0; ma < va.length; ma++)(sa =
                      va[ma]) && sa.selected && ua.push(sa);
                var za;
        ...
        (function() {
          var L = !1;
          C.Gf && Ra.L(U, function(J) {
            if (J.W && 0 !== J.pa.a && 1 !== J.pa.a) return L = !0, !1
          });
          L ? (Ra.sc(U, function(J) {
            if (J.W && (J.opacity !== J.Jc ||
                J.Fa)) {
              var W = J.m;
              if (W) {
                for (var ca = 0, ia = W.length - 1; 0 <= ia; ia--) ca = Math.max(ca, W[ia].Ec);
                J.Ec = ca + J.opacity * J.pa.a
              } else J.Ec = J.opacity * J.pa.a
            }
          }), Ra.L(U, function(J) {
            if (J.W && (J.opacity !== J.Jc || J.Fa)) {
              for (var W = J.Ec, ca = J;
                (ca = ca.parent) && ca !== U;) W += ca.opacity * ca.pa.a * C.Ef;
      ...
      function p() {
        var x = U.Z || U.N || "none" == C.Ke;
        if (!x && !U.empty()) {
          var A = U.m[0].scale;
          Ra.L(U, function(F) {
            if (F.W && F.Y &&
              F.scale !== A) return x = !0, !1
          })
        }!x && 0 < C.xe && 1 != C.Pa && Ra.L(U, function(F) {
          if (F.W && 0 < F.ja) return x = !0, !1
        });
        "accurate" == C.Ke && (x = (x = x || 0 === C.$a) || "none" != C.ld && C.$a < C.ab / 2, !x && C.$a < C.yc / 2 + C.kd * C.De.a && Ra.L(U, function(F) {
          if (F.W && (F.selected && !F.Sa || !F.selected && F.Sa)) return x = !0, !1
        }));
        return x
      }
      ...
      function m() {
        ...
        Ra.L(U, function(K) {
          if (K.W && K.U) return x.push("polygonExposureShadow"),
            !1
        });
        for (var A = x.length - 1; 0 <= A; A--) {
          var F = x[A];
          if (!!aa[F] !== !!N[F]) return !0
        }
        return !1
      }
  
      function c() {
        function x(J, W, ca, ia, la) {
          ...
          "auto" === ca && (oa = qa(J, oa, W, "labelPlainFill"));
          return J
        }
        var A = k === r,
          F = 0,
        ...
        switch (C.Ug) {
          case "plain":
            L.polygonPlainFill = !0;
            break;
          case "gradient":
            L.polygonPlainFill = !A, L.polygonGradientFill = A
        }
        switch (C.ld) {
          case "plain":
            L.polygonPlainStroke = !0;
            break;
          case "gradient":
            L.polygonPlainStroke = !A, L.polygonGradientStroke = A
        }
        aa = x(L, F, C.gj, C.ej, C.fj);
        N = x(L, 2 * K, "always", "always", C.Eg);
        ja = x(L, F, "always", "always", C.Dg)
      }
  
      function b(x) {
        return function(A, F) {
          return A === k ? !0 === aa[x] : !0 === (F ? N : ja)[x]
        }
      }
            ...
            if (1 < O / x.w) {
              ...
              if (A.Y && L)
                for (J = F.length - 1; 0 <= J; J--)
                  if (A = F[J], 1 !== A.scale && (A.Jb(x, K), K.w = x.w / A.scale, K.o = x.o / A.scale), !1 === A.Y && A.C) {
                    L = A.C;
                    var W = L.length;
                    if (wa.sa(A.C, 1 === A.scale ? x : K)) A.Y = !0;
                    else
                      for (var ca = 0; ca < W; ca++)
                        if (wa.Vc(L[ca], L[(ca + 1) % W], 1 === A.scale ? x : K)) {
                          A.Y = !0;
                          A.J && (A = A.J[ca]) && (F[A.index].Y = !0);
                          break
                        }
                  }
            } else
              for (J = 0; J < F.length; J++) F[J].Y = L
          }
        })
      }
      var u = ea.Se() ? 50 : 1E4,
        t, n, k, r, y, v, w, z, E, D, G, O, H, B, M = new mb(a),
        Q = new nb(a),
        X, Y, Z, C = a.options,
        U, ha, aa, ja, N;
      a.j.subscribe("stage:initialized", function(x, A, F, K) {
        B = x;
        O = F;
        H = K;
        ...
        G = D.getContext("2d");
        G.B = 1;
        [r, z, G].forEach(function(L) {
          L.scale(L.B, L.B)
        })
      });
      a.j.subscribe("stage:resized", function(x, A, F, K) {
        O = F;
        H = K;
        [r, z, G].forEach(function(L) {
          L.scale(L.B,
      ...
      a.j.subscribe("model:loaded", function(x) {
        function A(F) {
          var K = 0;
          if (!F.empty()) {
            for (var L = F.m, J = L.length - 1; 0 <= J; J--) K = Math.max(K, A(L[J]));
            K += 1
          }
          return F.Sf = K
        }
        ...
        A(U);
        c();
        a.j.D("render:renderers:resolved", aa, N, ja)
      });
      var S = "groupFillType groupStrokeType wireframeDrawMaxDuration wireframeLabelDrawing wireframeContentDecorationDrawing finalCompleteDrawMaxDuration finalIncrementalDrawMaxDuration groupContentDecorator".split(" "),
        ba = ["groupLabelLightColor", "groupLabelDarkColor", "groupLabelColorThreshold",
      ...
      a.j.subscribe("options:changed", function(x) {
        ...
        x.dataObject || (P.bb(x, S) && c(), P.bb(x, ba) && Ra.L(U, function(K) {
          K.hd = -1
        }));
        var F = P.has(x, "pixelRatio");
        x = P.has(x, "wireframePixelRatio");
        if (F || x) F && A(v, w, C.B, !0), x && A(n, k, C.nb, !0), A(D, G, Math.max(C.B, C.nb), !1)
      });
      ...
      var I = [{
          id: "offsetPolygon",
          Kd: function(x) {
            if ((x.selected || 0 < x.opacity && !1 === x.open || !x.X) && x.aa.Ga()) {
              var A = x.aa;
              A.clear();
              if (x.$) {
                var F = x.$,
                  K = C.Gg;
                0 < K ? ya.Ti(A, F, x.parent.O.r / 32, Math.min(1, K * Math.pow(1 - C.Hg * K, x.Sf))) : ya.Ud(A, F)
              }
              x.Dd = !0
            }
          }
          ...
          id: "custom",
          Kd: function(x, A) {
            if (x.$ && (0 < x.opacity && (!1 === x.open || !0 === x.selected) || !x.X) && x.oc && a.options.xc && !x.attribution) {
              var F = {};
              Z.Xc(F, x);
              Z.Yc(F, x);
              Z.Wc(F, x, !0);
              ...
              a.options.Kg(a.Cd, F, A);
              x.Te = A.groupLabelDrawn;
        ...
        T = [new function(x) {
          ...
          this.Nd = function(F, K, L) {
            if (0 !== F.length) {
              var J, W = [],
                ca = F[0].sb;
              for (J = 0; J < F.length; J++) {
                var ia = F[J];
                ia.sb !== ca && (W.push(J), ca = ia.sb)
              }
              W.push(J);
              for (var la = ca = 0; la < W.length; la++) {
                for (var qa = W[la], oa = x.length - 1; 0 <= oa; oa--)
                  if (A[oa]) {
                    var da = x[oa];
                    K.save();
                    for (J = ca; J < qa; J++) ia = F[J],
          ...
          this.na = function(F, K) {
            for (var L = !1, J = x.length - 1; 0 <= J; J--) A[J] = x[J].na(F, K), L |= A[J];
            return L
          };
          this.before = function(F, K) {
          ...
          this.ng = function(F) {
            for (var K = x.length - 1; 0 <= K; K--) {
              var L = x[K];
              if (A[K])
                for (var J = L.Ra.length - 1; 0 <= J; J--) F[L.Ra[J]] = !0
            }
          }
        }([{
          Ra: ["offsetPolygon"],
          ...
          rb: function() {},
          Wa: function(x) {
            this.Rf && (this.Rf = !1, x.save(), x.setTransform(1, 0, 0, 1, 0, 0), x.drawImage(D, 0, 0, x.canvas.width, x.canvas.height, 0, 0, x.canvas.width, x.canvas.height), x.restore(), G.save(), G.setTransform(1, 0, 0, 1, 0, 0), G.clearRect(0, 0, D.width, D.height), G.restore())
          },
          kb: function(x, A, F) {
            if (!(x.open && x.X || x.aa.Ga())) {
              var K = C.xe * x.opacity * x.ja * ("flattened" === C.mb ? 1 - x.parent.ja : (1 - x.Cb) * x.parent.Cb) *
                (1.1 <= C.Pa ? 1 : (C.Pa - 1) / .1);
              0 < K && (G.save(), G.beginPath(), x.Ib(G), x.aa.Na(G), G.shadowBlur = F * A.B * K, G.shadowColor = C.Mg, G.fillStyle = "rgba(0, 0, 0, 1)", G.globalCompositeOperation = "source-over", G.globalAlpha = x.opacity, G.fill(), G.shadowBlur = 0, G.shadowColor = "transparent", G.globalCompositeOperation = "destination-out", G.fill(), G.restore(), this.Rf = !0)
            }
          }
        }, {
          Ra: ["offsetPolygon"],
          ...
          before: function() {
            function x(L) {
              var J = L.pa,
                W = L.ub,
                ca = L.selected,
                ia = (J.h + (W ? C.Yg : 0) + (ca ? C.ph : 0)) % 360,
                la = A(J.l * L.va +
                  (W ? C.Zg : 0) + (ca ? C.qh : 0));
              J = A(J.s * L.saturation + (W ? C.$g : 0) + (ca ? C.rh : 0));
              L = L.we;
              L.h = ia;
              L.s = J;
              L.l = la;
            ...
            function A(L) {
              return 100 < L ? 100 : 0 > L ? 0 : L
            }
            var F = [{
                type: "fill",
                na: b("polygonPlainFill"),
                Pc: function(L, J) {
                  J.fillStyle = Ea.H(x(L))
                }
              }, {
                type: "fill",
                ...
                Pc: function(L, J) {
                  var W = L.O.r,
                    ca = x(L);
                  W = J.createRadialGradient(L.x, L.y, 0, L.x, L.y, W * C.Qg);
                  var ia = ca.l,
                    la = C.Og;
                  W.addColorStop(0, Ea.i((ca.h + C.Ng) % 360, A(ca.s + C.Pg), A(ia + la)));
                  ia = ca.l;
                  la = C.Sg;
                  W.addColorStop(1, Ea.i((ca.h + C.Rg) % 360, A(ca.s +
                    C.Tg), A(ia + la)));
                  L.aa.Na(J);
                  J.fillStyle = W
                }
                ...
                Pc: function(L, J) {
                  var W = L.pa,
                    ca = L.ub,
                    ia = L.selected,
                    la = (W.h + C.He + (ca ? C.ye : 0) + (ia ? C.Ee : 0)) % 360,
                    qa = A(W.s * L.saturation + C.Je + (ca ? C.Ae : 0) + (ia ? C.Ge : 0));
                  W = A(W.l * L.va + C.Ie + (ca ? C.ze : 0) + (ia ? C.Fe : 0));
                  J.strokeStyle = Ea.i(la, qa, W);
                  J.lineWidth = C.ab * Math.pow(C.La, L.level - 1)
                }
              }, {
                type: "stroke",
                ...
                Pc: function(L, J) {
                  var W = L.O.r * C.xh,
                    ...
                    ia = Math.PI *
                    C.th / 180;
                  W = J.createLinearGradient(L.x + W * Math.cos(ia), L.y + W * Math.sin(ia), L.x + W * Math.cos(ia + Math.PI), L.y + W * Math.sin(ia + Math.PI));
                  var la = L.ub,
                    qa = L.selected;
                  ia = (ca.h + C.He + (la ? C.ye : 0) + (qa ? C.Ee : 0)) % 360;
                  var oa = A(ca.s * L.saturation + C.Je + (la ? C.Ae : 0) + (qa ? C.Ge : 0));
                  ca = A(ca.l * L.va + C.Ie + (la ? C.ze : 0) + (qa ? C.Fe : 0));
                  la = C.vh;
                  W.addColorStop(0, Ea.i((ia + C.uh) % 360, A(oa + C.wh), A(ca + la)));
                  la = C.zh;
                  W.addColorStop(1, Ea.i((ia + C.yh) % 360, A(oa + C.Ah), A(ca + la)));
                  J.strokeStyle = W;
                  J.lineWidth = C.ab * Math.pow(C.La, L.level - 1)
                }
              }],
              K = Array(F.length);
            return function(L, J) {
              for (var W = F.length - 1; 0 <= W; W--) K[W] = F[W].na(L, J);
              this.Xi = F;
              this.vg = K
            }
          }(),
          ...
          kb: function(x, A) {
            if (!(!x.Ed || (0 === x.opacity || x.open) && x.X || x.aa.Ga() || !C.je && x.description)) {
              ...
              A.beginPath();
              x.aa.Na(A);
              for (var L = !1, J = !1, W = F.length - 1; 0 <= W; W--) {
                var ca = F[W];
                if (K[W]) switch (ca.Pc(x, A), ca.type) {
                  case "fill":
                    L = !0;
                    break;
                  case "stroke":
              ...
              K = !x.empty();
              W = C.Gf ? x.$c : 1;
              L && (x = K && x.X && x.R && x.m[0].W ? 1 -
                x.m.reduce(function(ia, la) {
                  return ia + la.ra * la.Hd
                }, 0) / x.m.length * (1 - C.Ef) : 1, A.globalAlpha = F * x * W, ob(A));
              J && (A.globalAlpha = F * (K ? C.Xh : 1) * W, A.closePath(), pb(A), A.stroke())
            }
          }
        }, {
          Ra: ["offsetPolygon"],
          ...
          kb: function(x, A, F) {
            if (x.Ed && x.selected && !x.aa.Ga()) {
              A.globalAlpha = x.Da;
              A.beginPath();
              var K = Math.pow(C.La, x.level - 1);
              A.lineWidth = C.yc * K;
              A.strokeStyle = C.sh;
              var L = C.kd;
              0 < L && (A.shadowBlur = L * K * F * A.B, A.shadowColor = C.Ce);
              x.aa.Na(A);
              A.closePath();
              A.stroke()
            }
          ...
          kb: function(x, A) {
            function F(K, L, J) {
              var W = wa.Ka(x.$, x.O, K / L);
              W = Math.min(Math.min(.9 * W, .5 * x.F.o) / L, .5 * x.F.w / K);
              A.save();
              A.translate(x.x, x.y);
            ...
            x.attribution && !x.aa.Ga() && F(kb.i.width, kb.i.height, function(K) {
              kb.u(K, C.ae)
            })
          }
        }, {
          ...
          Wa: function() {},
          kb: function(x, A, F) {
            (0 < x.opacity && 0 < x.ca && !x.open || !x.X) && !x.aa.Ga() && (x.Cc = x.oa && x.oa.ka && C.B * x.oa.fontSize * x.scale * F >= C.mh, "auto" === x.pd ? !C.je && x.description ? x.fb = x.parent.fb : (F = x.we, A = F.h + (F.s << 9) + (F.l << 16), x.hd !== A && (F = Ea.T(F), x.fb = F > (0 > x.ja ? C.Bh : C.ah) ? C.bh : C.lh, x.hd = A)) : x.fb = x.pd)
          }
        }, {
          Ra: ["custom"],
          ...
          Wa: function() {},
          kb: function(x, A) {
            !(0 < x.opacity && 0 < x.ca && !x.open || !x.X) || x.Qb.Ga() || x.aa.Ga() || (x.Cc || void 0 === x.oa ? (A.globalAlpha = x.ca * (x.X ? x.opacity : 1) * (x.empty() ? 1 : C.Ff), A.fillStyle = x.fb, A.strokeStyle = x.fb, x.Qb.Na(A)) : l(x, A))
          }
        }, {
          Ra: ["label"],
          na: b("labelPlainFill"),
          ...
          Wa: function() {},
          kb: function(x, A, F) {
            x.Te && x.Fc && (0 < x.opacity && 0 < x.ca && !x.open || !x.X) && !x.aa.Ga() && x.oa && (A.fillStyle = x.fb, A.globalAlpha =
              x.ca * (x.X ? x.opacity : 1) * (x.empty() ? 1 : C.Ff), x.Cc ? qb(x, A, F) : l(x, A))
          }
        }].reverse())];
      this.M = function() {
        t = Ma.Hh(function() {
      ...
      this.i = function(x) {
        ...
        var A = d(),
          F = C.B;
        try {
          var K = P.I(x.pixelRatio, C.B);
          C.B = K;
          var L = B.dc("export", K, !0),
            J = L.getContext("2d");
          k === y && (J = new xa(J));
          J.scale(K, K);
          var W = P.has(x, "backgroundColor");
          W && (J.save(), J.fillStyle = x.backgroundColor, J.fillRect(0, 0, O, H),
            J.restore());
          g(W ? [] : null, A.ag, J, !0)
        } finally {
          C.B = F
        }
        return L.toDataURL(P.I(x.format, "image/png"), P.I(x.quality, .8))
      };
      var fa = function() {
        function x(K, L, J, W, ca, ia) {
          ...
          if (!qa || !oa) {
            ...
            F = [];
            qa || F.push(la(K, L, J, La.Gb));
            oa || F.push(la(W, ca, ia, La.Tf));
        ...
        return {
          Vi: function() {
            C.Zc ? 1 !== n.style.opacity && (n.style.visibility = "visible", v.style.visibility = "hidden", n.style.opacity = 1, v.style.opacity = 0) : A && A.xb() || (A = x("wireframe", 1, C.se, "hifi", 0, C.se))
          },
          Ui: function() {
            C.Zc ? (v.style.visibility = "visible", n.style.visibility = "hidden", n.style.opacity = 0, v.style.opacity = 1) : x("hifi", 1, C.dg, "wireframe", 0, C.dg)
          }
        }
      }();
      tb = function(x) {
    ...
    function mb(a) {
      function q(c) {
        ...
        "undefined" !== typeof c.groupLabelHorizontalPadding && (g.cb =
          c.groupLabelHorizontalPadding);
      ...
      this.i = function(c) {
        if (!c.$) return !1;
        var b = c.group.label;
        l.eh && !c.attribution && (p.labelText =
          b, d.nc(l.dh, c, p), b = p.labelText);
        c.Ue = b;
        return c.qd !== b
      };
      this.u = function(c) {
        ...
        c.Bc.clear();
        c.oa = void 0;
        if (c.$ && !P.Ne(b) && ("flattened" !== l.mb || c.empty() || !c.R || !c.m[0].W)) {
          var h = ta,
            f = h.de;
          if (l.kh) {
          ...
          c.oa = f.call(h, u, c.Bc, b, c.$, c.F, c.O, !1, !1, c.Mh, c.O.ha, l.nh, c.Ma)
        }
        c.Ma = !1
      };
    ...
    function nb(a) {
      ...
      function l(b, h) {
        b = b.m;
        var f = b.length;
        if (1 === f || 2 === f && b[0].description) b[0].tb = .5;
        else {
          var u = 0,
            t = Number.MAX_VALUE,
            n = Math.sin(h),
        ...
        function b(z) {
          if (z.R && z.xa) {
            var E = z.m,
              D;
            if (z.Z || z.Fa || y) {
              0 === z.level ? u(z, d.wi * Math.PI / 180) : t(z, d.Ai * Math.PI / 180);
              for (D = E.length - 1; 0 <= D; D--) {
                ...
                if (0 === z.level) {
                  ...
                  var Q = (1 + (0 > G.ja ? v * (G.ja + 1) : v) * (1 - G.wc)) *
                    g(O, n, k, "l");
                  var X = g(O, n, k, "a")
                } else Q = z.pa, B = Q.h, M = Q.s, Q = h(Q.l, O, d.Bi, d.Ci), X = z.ve.a;
                H.h = B;
                H.s = M;
                H.l = Q;
                H.a = X;
    ...
    function Za() {
      this.kc = this.Yd = this.hc = this.Vf = this.w = this.cg = this.weight = this.y = this.x = this.id = 0;
      ...
      this.Fd =
        this.G = null;
      this.Fc = this.W = this.Sa = this.oc = this.Vd = this.Dd = this.Ma = this.Fa = this.N = this.Z = this.Ea = this.xa = this.R = this.Ia = !1;
      ...
      this.vd = function() {
        var e = !1;
        this.scale = 1;
        for (var d = 0; d < a.length; d++) e = a[d].Ve(this, q) || e, this.scale *= q.scale;
        return e
      };
      this.Ib = function(e) {
        ...
        if (b) {
          ...
          if (!(0 >= t || 0 >= n)) {
            var k = b.Cc ? b.oa.fontSize * b.scale * c.scale() : 0,
              r = {
                titleBarText: b.qd,
                titleBarTextColor: p.Zf,
                titleBarBackgroundColor: p.Yf,
                titleBarMaxFontSize: p.Wd,
                titleBarShown: k < p.Sh
              };
            if (b.attribution) var y = Pa.Pf("B`ssnu!Rd`sbi!Gn`lUsdd!whrt`mh{`uhno/!Busm,bmhbj!uid!mnfn!un!fn!un!iuuqr;..b`ssnurd`sbi/bnl.gn`lusdd!gns!lnsd!edu`hmr/");
            else m.nc(p.Yi, b, r, function(v) {
              v.titleBarWidth = n;
              v.titleBarHeight = t;
              v.labelFontSize =
                k;
            ...
            y && 0 !== y.length && r.titleBarShown && (b = c.Uc(b.transformPoint(b, {}), {}).y > d / 2, h = {
              x: f,
              y: b ? h : d - u + h,
              w: n,
              o: t
            }, f = wa.H(h), g.fillStyle = p.Yf, g.fillRect(0, b ? 0 : d - u, e, u), g.fillStyle = p.Zf, ta.re({
              fontFamily: p.Zi || p.fh,
              fontStyle: p.Aj || p.gh,
              fontWeight: p.Cj || p.ih,
              fontVariant: p.Bj || p.hh,
              hb: p.Wd,
              Gc: p.$i,
              cb: 0,
              Ua: 0,
    ...
    function vb(a) {
      ...
      function g(v, w) {
        return c.i((0 !== c.u() ? .35 : 1) * v, (0 !== c.H() ? .35 : 1) * w)
      }
  
      function e() {
        if (1 === b.ratio) {
          var v = Math.round(1E4 * c.u()) / 1E4;
          0 !== v && (f.Id = v, h = r.K.jc(f).fa({
            duration: 500,
            P: {
              x: {
                start: v,
      ...
      this.cj = m(function(v, w) {
        c.ic(v, w) && l(1)
      });
      this.Uh = m(function(v,
        w) {
        1 === b.ratio && g(v, w) && l(1)
      });
      this.qg = m(function(v, w) {
        c.Nb(v, w) && l(1)
      });
      this.pg = m(function(v, w, z, E) {
        v = 0 | c.Nb(v, w);
        (v |= g(z, E)) && l(1)
      });
      this.Vh = m(function(v, w, z) {
        1 === b.ratio && (h = r.K.jc(f).fa({
          duration: v / .03,
          P: {
            ke: {
              start: w,
    ...
    function wb(a, q, l) {
      ...
      function e(I, T) {
        ...
        var x = 0 < V + fa ? R : 0,
          A = [];
        Va.u(I, Va.i(I, f.options.Qd), function(F, K, L) {
          K = "groups" === f.options.Pd ? L : K;
          F.m && (F = n.K.A(F).wait(x * (fa + V * K)).call(T).done(), A.push(F))
        });
        return n.K.A({}).Qa(A).Ta()
      }
  
      function d(I) {
        ba || (ba = !0, t.once(function() {
          ba = !1;
      ...
      function p(I) {
        function T(A, F) {
          ...
          A.Fc = F <= V;
          A.W !==
            K && Ra.me(A, function(L) {
              L.Vd = !0
            });
          A.open || A.Va || F++;
          if (A = A.m)
            for (K = 0; K < A.length; K++) T(A[K], F)
        }
        var R = f.options.We,
          V = Math.min(f.options.We, f.options.Ph);
        if (I)
      ...
      function m(I, T) {
        var R = [];
        I = c(I, T);
        I.Th && f.j.D("model:childrenAttached", Ra.uc(u));
        I.Gi && z.complete(function(fa) {
          N.eb(fa);
          R.push(fa)
        });
      ...
      function c(I, T) {
        function R(K, L) {
          var J = !K.attribution && L - (K.Va ? 1 : 0) <
            V;
          x = x || J;
          K.Ia = K.Ia || J;
          K.open || K.Va || L++;
          var W = K.m;
          !W && J && (fa = w.T(K) || fa, W = K.m, F && (K.Ma = !0));
          if (W)
            for (K = 0; K < W.length; K++) A.push(W[K], L)
        }
        var V = T || f.options.Qh,
          fa = !1,
          x = !1,
          A, F = "flattened" === q.mb;
        for (I ? A = I.reduce(function(K, L) {
            K.push(L, 1);
            return K
      ...
      var M = "groupLabelFontFamily groupLabelFontStyle groupLabelFontVariant groupLabelFontWeight groupLabelLineHeight groupLabelHorizontalPadding groupLabelVerticalPadding groupLabelDottingThreshold groupLabelMaxTotalHeight groupLabelMinFontSize groupLabelMaxFontSize groupLabelDecorator".split(" "),
        ...
        Z = ["maxGroupLevelsDrawn", "maxGroupLabelLevelsDrawn"];
      this.hg = function(I) {
      ...
      this.wa = function() {
        ...
        return function(R, V) {
          return (R = w.i(R)) ? (I.x = V.x, I.y = V.y, R.transformPoint(I, I), y.Uc(I, I), T.x = I.x, T.y =
            I.y, T) : null
        }
      }();
      this.sa = function() {
      ...
      this.mg = function(I) {
        return (I = w.i(I)) ?
          I === u ? y.reset(q.ob, La.ia(q.Kb)) : y.bg(I, q.Yb, q.ob, La.ia(q.Kb)) : (new Fa).resolve().promise()
      };
      ...
      var C = function() {
          function I(fa, x) {
            ...
            R = A;
            V = F;
            (fa = q.Rb && q.Rb.boundary) && 2 < fa.length ? u.C = fa.map(function(K) {
              return {
                x: A * K.x,
                y: F * K.y
              }
          ...
          return {
            Le: I,
            Ki: function(fa, x, A, F) {
              N.stop();
              var K = A / fa,
                L = F / x;
              Ra.ne(u, function(J) {
                J.x = J.x * K + (Math.random() - .5) * A / 1E3;
                J.y = J.y * L + (Math.random() - .5) * F / 1E3
              });
              I(A, F);
              u.Ea = !0;
              z.step(N.eb, !0, !1, function(J) {
                ...
                if (W) {
                  z.Eb(J);
                  for (var ca = W.length - 1; 0 <= ca; ca--) {
                    var ia = W[ca];
                    ia.w = ia.hc
                  }
                  J.Ea = !0
                }
              }) ? d(!1) : (z.fc(u), f.options.Md ? (d(!1), ja.Jf(), ja.Oc()) : (z.complete(N.eb), u.Fa = !0, d(!1)))
            },
            Nh: function(fa) {
              var x = !1;
              u.empty() || (T(),
                ja.xb() || (x = z.step(N.eb, !1, !1), d(fa)));
              return x
            },
            dj: function(fa) {
              fa.forEach(function(x) {
                ...
                z.fc(x);
                f.options.Md ? (ja.Jf(), Ra.za(x, function(A) {
                  A.empty() || N.grow(A)
                })) : (Ra.za(x, function(A) {
                  A.empty() || N.eb(A)
                }), z.complete(N.eb), x.Fa = !0, d(!1))
              })
            }
          }
        }(),
        U = function() {
          function I() {
            ...
            f.options.yf(q.Rb);
            F && (f.options.Cf(), F.then(function() {
              E.u(function() {
                t.once(f.options.Bf)
              })
            }))
          ...
          function R(F, K) {
            return 0 === q.qe || K ? (r.i(F), (new Fa).resolve().promise()) : n.K.A({
              opacity: r.i()
            }).Xd(2).fa({
              duration: q.qe,
              P: {
          ...
          function V() {
            ...
            e(u, function J() {
              this.R &&
                this.C && (this.Z = this.xa = !0, K.i(), O.i(this).then(K.u), K.i(), e(this, J).then(K.u))
            });
            return F.promise()
          }
          ...
          function fa() {
            for (var F = 0; F < A.length; F++) {
              var K = A[F],
                L = K.action();
              P.has(L, "then") ? L.then(K.ge.resolve) : K.ge.resolve()
            }
            A = []
          }
          var x = !1,
          ...
          return {
            reload: function() {
              x || (u.empty() ? I() : (N.stop(), n.i(), ja.stop(), x = !0, Ga(0 < q.Gd ? [O.u(), S(!1)] : [R(0)]).then(function() {
                R(0, !0);
                x = !1;
                I();
                P.defer(fa)
        ...
        ha, aa = new Ha(function() {
          ha.resolve()
        }),
        ja = function() {
          function I() {
            V || (aa.initial() && (ha = new Fa), aa.i(), T(), V = !0, t.repeat(R));
            return ha.promise()
          }
          ...
          return {
            grow: function(R) {
              ...
              0 < fa ? Va.u(R, Va.i(R, f.options.Qd), function(x, A, F) {
                ...
                aa.i();
                T.push(n.K.A(x).wait(A * V.Vg * fa).fa({
                  duration: fa,
                  P: {
                    w: {
                      start: x.Vf,
    ...
    ea.md(function() {
      window.CarrotSearchFoamTree = function(a) {
        ...
        function e(u) {
          (function() {
            ...
            b.mb = c.stacking;
            b.zg = c.descriptionGroup;
            b.Tb = c.descriptionGroupType;
            b.qc = c.descriptionGroupPosition;
            b.Ag = c.descriptionGroupDistanceFromCenter;
            ...
            b.Wi = c.showZeroWeightGroups;
            b.Be = c.groupMinDiameter;
            b.Ld = c.rectangleAspectRatioPreference;
            b.Ii = c.initializer || c.relaxationInitializer;
            b.Ji = c.relaxationMaxDuration;
            b.Md = c.relaxationVisible;
            b.Hf = c.relaxationQualityThreshold;
            b.oh = c.groupResizingBudget;
            b.Wg = c.groupGrowingDuration;
            b.Vg = c.groupGrowingDrag;
            b.Xg = c.groupGrowingEasing;
            b.Gg = c.groupBorderRadius;
            b.$a = c.groupBorderWidth;
            b.La = c.groupBorderWidthScaling;
            b.jd = c.groupInsetWidth;
            b.Hg = c.groupBorderRadiusCorrection;
            b.ab = c.groupStrokeWidth;
            b.yc = c.groupSelectionOutlineWidth;
            b.sh = c.groupSelectionOutlineColor;
            b.kd = c.groupSelectionOutlineShadowSize;
            b.Ce = c.groupSelectionOutlineShadowColor;
            b.ph = c.groupSelectionFillHueShift;
            b.rh = c.groupSelectionFillSaturationShift;
            b.qh = c.groupSelectionFillLightnessShift;
            b.Ee = c.groupSelectionStrokeHueShift;
            b.Ge = c.groupSelectionStrokeSaturationShift;
            b.Fe = c.groupSelectionStrokeLightnessShift;
            b.Ug = c.groupFillType;
            b.Qg = c.groupFillGradientRadius;
            b.Ng = c.groupFillGradientCenterHueShift;
            b.Pg =
              c.groupFillGradientCenterSaturationShift;
            b.Og = c.groupFillGradientCenterLightnessShift;
            b.Rg = c.groupFillGradientRimHueShift;
            b.Tg = c.groupFillGradientRimSaturationShift;
            b.Sg = c.groupFillGradientRimLightnessShift;
            b.ld = c.groupStrokeType;
            b.ab = c.groupStrokeWidth;
            b.He = c.groupStrokePlainHueShift;
            b.Je = c.groupStrokePlainSaturationShift;
            b.Ie = c.groupStrokePlainLightnessShift;
            b.xh = c.groupStrokeGradientRadius;
            b.th = c.groupStrokeGradientAngle;
            b.yh = c.groupStrokeGradientUpperHueShift;
            b.Ah = c.groupStrokeGradientUpperSaturationShift;
            ...
            b.Yg = c.groupHoverFillHueShift;
            b.$g = c.groupHoverFillSaturationShift;
            b.Zg = c.groupHoverFillLightnessShift;
            b.ye = c.groupHoverStrokeHueShift;
            b.Ae = c.groupHoverStrokeSaturationShift;
            b.ze = c.groupHoverStrokeLightnessShift;
            b.Pa = c.groupExposureScale;
            b.Mg = c.groupExposureShadowColor;
            b.xe = c.groupExposureShadowSize;
            b.Yb = c.groupExposureZoomMargin;
            b.Ch = c.groupUnexposureLightnessShift;
            b.Dh = c.groupUnexposureSaturationShift;
            b.Bh = c.groupUnexposureLabelColorThreshold;
            b.Oa = c.exposeDuration;
            b.Wb = c.exposeEasing;
            b.Kc = c.openCloseDuration;
            b.Ig = Na.A(c.groupColorDecorator, p);
            b.Jg = c.groupColorDecorator !== P.qa;
            b.dh = Na.A(c.groupLabelDecorator, p);
            b.eh = c.groupLabelDecorator !== P.qa;
            b.jh = Na.A(c.groupLabelLayoutDecorator, p);
            b.kh = c.groupLabelLayoutDecorator !== P.qa;
            b.Kg = Na.A(c.groupContentDecorator, p);
            b.xc = c.groupContentDecorator !== P.qa;
            b.Lg = c.groupContentDecoratorTriggering;
            b.Ei = c.rainbowStartColor;
            b.xi = c.rainbowEndColor;
            b.vi = c.rainbowColorDistribution;
            b.wi = c.rainbowColorDistributionAngle;
            b.Ai = c.rainbowLightnessDistributionAngle;
            b.Bi = c.rainbowLightnessShift;
            b.Ci = c.rainbowLightnessShiftCenter;
            b.Di = c.rainbowSaturationCorrection;
            b.zi = c.rainbowLightnessCorrection;
            b.Ef = c.parentFillOpacity;
            b.Xh = c.parentStrokeOpacity;
            b.Ff = c.parentLabelOpacity;
            b.Gf = c.parentOpacityBalancing;
            b.nh = c.groupLabelUpdateThreshold;
            b.fh = c.groupLabelFontFamily;
            b.gh = c.groupLabelFontStyle;
            b.hh = c.groupLabelFontVariant;
            b.ih = c.groupLabelFontWeight;
            b.mh = c.groupLabelMinFontSize;
            b.sj = c.groupLabelMaxFontSize;
            b.rj = c.groupLabelLineHeight;
            b.qj = c.groupLabelHorizontalPadding;
            b.uj = c.groupLabelVerticalPadding;
            b.tj = c.groupLabelMaxTotalHeight;
            b.bh = c.groupLabelDarkColor;
            b.lh = c.groupLabelLightColor;
            b.ah = c.groupLabelColorThreshold;
            b.fj = c.wireframeDrawMaxDuration;
            b.gj = c.wireframeLabelDrawing;
            b.ej = c.wireframeContentDecorationDrawing;
            b.dg = c.wireframeToFinalFadeDuration;
            b.hj = c.wireframeToFinalFadeDelay;
            b.Dg = c.finalCompleteDrawMaxDuration;
            b.Eg = c.finalIncrementalDrawMaxDuration;
            b.se = c.finalToWireframeFadeDuration;
            b.Zc = c.androidStockBrowserWorkaround;
            b.Ke = c.incrementalDraw;
            b.Rh = c.maxGroups;
            b.Qh = c.maxGroupLevelsAttached;
            b.We = c.maxGroupLevelsDrawn;
            b.Ph = c.maxGroupLabelLevelsDrawn;
            b.Qd = c.rolloutStartPoint;
            b.Pd = c.rolloutMethod;
            b.Ni = c.rolloutEasing;
            b.Od = c.rolloutDuration;
            b.Lf = c.rolloutScalingStrength;
            b.Nf = c.rolloutTranslationXStrength;
            b.Of = c.rolloutTranslationYStrength;
            b.Kf = c.rolloutRotationStrength;
            b.Mf = c.rolloutTransformationCenter;
            b.Ri =
              c.rolloutPolygonDrag;
            b.Si = c.rolloutPolygonDuration;
            b.Oi = c.rolloutLabelDelay;
            b.Pi = c.rolloutLabelDrag;
            b.Qi = c.rolloutLabelDuration;
            b.Mi = c.rolloutChildGroupsDrag;
            b.Li = c.rolloutChildGroupsDelay;
            b.ni = c.pullbackStartPoint;
            b.hi = c.pullbackMethod;
            b.di = c.pullbackEasing;
            b.yj = c.pullbackType;
            b.Gd = c.pullbackDuration;
            b.mi = c.pullbackScalingStrength;
            b.pi = c.pullbackTranslationXStrength;
            b.ri = c.pullbackTranslationYStrength;
            b.li = c.pullbackRotationStrength;
            b.oi = c.pullbackTransformationCenter;
            b.ii = c.pullbackPolygonDelay;
            b.ji = c.pullbackPolygonDrag;
            b.ki = c.pullbackPolygonDuration;
            b.ei = c.pullbackLabelDelay;
            b.fi = c.pullbackLabelDrag;
            b.gi = c.pullbackLabelDuration;
            b.ai = c.pullbackChildGroupsDelay;
            b.bi = c.pullbackChildGroupsDrag;
            b.ci = c.pullbackChildGroupsDuration;
            b.qe = c.fadeDuration;
            b.Cg = c.fadeEasing;
            b.ij = c.zoomMouseWheelFactor;
            b.ob = c.zoomMouseWheelDuration;
            b.Kb = c.zoomMouseWheelEasing;
            b.Sh = c.maxLabelSizeForTitleBar;
            b.Zi = c.titleBarFontFamily;
            b.Yf = c.titleBarBackgroundColor;
            b.Zf = c.titleBarTextColor;
            b.$i = c.titleBarMinFontSize;
            b.Wd =
              c.titleBarMaxFontSize;
            b.aj = c.titleBarTextPaddingLeftRight;
            b.bj = c.titleBarTextPaddingTopBottom;
            b.Yi = c.titleBarDecorator;
            b.mj = c.attributionText;
            b.jj = c.attributionLogo;
            b.lj = c.attributionLogoScale;
            b.nj = c.attributionUrl;
            b.$d = c.attributionPosition;
            b.rg = c.attributionDistanceFromCenter;
            b.sg = c.attributionWeight;
            b.ae = c.attributionTheme;
            b.Me = c.interactionHandler;
            b.zf = t("onModelChanging", b.zf);
            b.yf = t("onModelChanged", b.yf);
            b.Af = t("onRedraw", b.Af);
            b.Cf = t("onRolloutStart", b.Cf);
            b.Bf = t("onRolloutComplete", b.Bf);
            b.Ad = t("onRelaxationStep", b.Ad);
            b.Df = t("onViewReset", b.Df);
            b.rf = t("onGroupOpenOrCloseChanging", b.rf);
            b.qf = t("onGroupOpenOrCloseChanged", b.qf);
            b.hf = t("onGroupExposureChanging", b.hf);
            b.gf = t("onGroupExposureChanged", b.gf);
            b.tf = t("onGroupSelectionChanging", b.tf);
            b.sf = t("onGroupSelectionChanged", b.sf);
            b.kf = t("onGroupHover", b.kf);
            b.mf = t("onGroupMouseMove", b.mf);
            b.bf = t("onGroupClick", b.bf);
            b.cf = t("onGroupDoubleClick", b.cf);
            b.jf = t("onGroupHold", b.jf);
            b.pf = t("onGroupMouseWheel", b.pf);
            b.nf = t("onGroupMouseUp",
              b.nf);
            b.lf = t("onGroupMouseDown", b.lf);
            b.ff = t("onGroupDragStart", b.ff);
            b.df = t("onGroupDrag", b.df);
            b.ef = t("onGroupDragEnd", b.ef);
            b.wf = t("onGroupTransformStart", b.wf);
            b.uf = t("onGroupTransform", b.uf);
            b.vf = t("onGroupTransformEnd", b.vf);
            b.xf = t("onKeyUp", b.xf)
          })();
          b.Fi = Ea.u(b.Ei);
          b.yi = Ea.u(b.xi);
          b.De = Ea.u(b.Ce);
          b.kj = null;
          h && (h.hg(u), P.has(u, "dataObject") && h.reload())
        }
  
        function d(u) {
          return function() {
            return u.apply(this, arguments).Fg(p)
          }
        }
        var p = this,
      ...
      window.CarrotSearchFoamTree.defaults = Object.freeze({
        ...
        interactionHandler: ea.Gh() ? "hammerjs" : "builtin",
        onModelChanging: [],
        onModelChanged: [],
        onRedraw: [],
        onRolloutStart: [],
